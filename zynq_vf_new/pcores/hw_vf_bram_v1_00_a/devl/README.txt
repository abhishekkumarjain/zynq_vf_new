...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\Dropbox\Dropbox\Workspace\zynq_vf
  logical library name                       : hw_vf_bram_v1_00_a
  top name                                   : hw_vf_bram
  version                                    : 1.00.a
  type                                       : AXI4 slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/hw_vf_bram_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/hw_vf_bram_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/hw_vf_bram_v2_1_0.tcl
...
axi_slave_burst_v1_00_a
	D:\Dropbox\Dropbox\Workspace\zynq_vf\D:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_slave_burst_v1_00_a\doc\ds769_axi_slave_burst.pdf
