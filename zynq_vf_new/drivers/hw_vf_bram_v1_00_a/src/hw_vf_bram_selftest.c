/*****************************************************************************
* Filename:          D:\Dropbox\Dropbox\Workspace\zynq_vf/drivers/hw_vf_bram_v1_00_a/src/hw_vf_bram_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the hw_vf_bram driver
* Date:              Mon Nov 26 17:46:36 2012 (by Create and Import Peripheral Wizard)
*****************************************************************************/


/***************************** Include Files *******************************/

#include "hw_vf_bram.h"
...
XStatus HW_VF_BRAM_SelfTest(void * baseaddr_p)
{
  ...
  {
    HW_VF_BRAM_mWriteMemory(baseaddr+4*Index, (0xDEADBEEF % Index));
  }

  for ( Index = 0; Index < 256; Index++ )
  {
    Mem32Value = HW_VF_BRAM_mReadMemory(baseaddr+4*Index);
